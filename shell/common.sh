...
claude() { _siren_agent_gate claude || return 1; _siren_agent_launch claude "$@"; }
codex() { _siren_agent_gate codex || return 1; _siren_agent_launch codex "$@"; }
opencode() { _siren_agent_gate opencode || return 1; _siren_agent_launch opencode "$@"; }
