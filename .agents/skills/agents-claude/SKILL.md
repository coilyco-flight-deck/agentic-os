...
- Large context, semantic skill-selection - picks by fit, not exact string match.
- Carries multi-step reasoning and judgment; where [`models-qwen`](../models-qwen/SKILL.md) escalates to.
