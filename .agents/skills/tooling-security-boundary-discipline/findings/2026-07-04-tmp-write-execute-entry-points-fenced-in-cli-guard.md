---
date: 2026-07-04
slug: tmp-write-execute-entry-points-fenced-in-cli-guard
promoted_to:
---
...
**Verdict: every write+execute ad-hoc /tmp entry point coily#118 enumerated is fenced at the engine layer** - fenced at the capability layer (deny what it does), not by enumerating names, which is what [`2026-05-08-deny-uv-bypassed-by-venv-binary`](2026-05-08-deny-uv-bypassed-by-venv-binary.md) recommended.
