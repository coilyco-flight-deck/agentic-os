...
Reference for the Assumption Testing mode in [`../SKILL.md`](../SKILL.md). Use to break a business or career assumption before the market does. Revenue projections, market size, competitive moat, hiring velocity, customer retention.

Source: adapted from alirezarezvani/claude-skills `c-level-advisor/executive-mentor/skills/stress-test`.
...
The fan-in runs in five steps: isolate the assumption, find counter-evidence, model the downside, calculate sensitivity, propose the hedge.

- [`stress-test-method.md`](stress-test-method.md) - the full five-step walkthrough with assumption types, counter-evidence sources, the downside-scenario table, sensitivity examples, and the three hedge types.

## Patterns by assumption type

- [`stress-test-patterns.md`](stress-test-patterns.md) - common failures, stress questions, and the cheapest test for revenue projections, market size, competitive moat, hiring plan, and competitive response.
