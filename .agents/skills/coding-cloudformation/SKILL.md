...
**Stub.** A situational leaf of [`coding-shape-iac`](../coding-shape-iac/SKILL.md). Fill with real conventions later.
...
- [`coding-terraform`](../coding-terraform/SKILL.md) - the default over CloudFormation.
- [`coding-aws`](../coding-aws/SKILL.md) - the cloud CFN targets.
