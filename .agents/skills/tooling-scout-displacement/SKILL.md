...
sibling [tooling-scout-capability](../tooling-scout-capability/SKILL.md) runs the
opposite direction: external catalog in, "what capability is missing that I should
acquire?"
...
(stars, last release, maintainers, license) and run supply-chain-audit before any
unvetted adoption; and a subsystem that is the repo's whole reason for being usually
stays custom.
...
- [tooling-supply-chain-audit](../tooling-supply-chain-audit/SKILL.md) - the dependency-risk gate before adopting.
