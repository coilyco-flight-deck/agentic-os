...
Its sibling [tooling-scout-displacement](../tooling-scout-displacement/SKILL.md)
runs the opposite direction: your custom code in, matched to off-the-shelf OSS,
...
[tooling-scout-displacement](../tooling-scout-displacement/SKILL.md) - the **outbound** half. The two scouts are one portfolio-management activity run in opposite directions:
