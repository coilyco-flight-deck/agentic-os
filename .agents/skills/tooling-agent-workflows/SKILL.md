...
- [Where the docs live in code](references/docs-in-code.md) - embed one markdown file per surface, what stays in the skill, and applying it to `ward dispatch`.
