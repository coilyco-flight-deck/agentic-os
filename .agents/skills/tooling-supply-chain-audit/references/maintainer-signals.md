...
If the bio claims a public credential, spot-check at least one against the directory that would list it. The per-credential lookup table continues in [`maintainer-credentials.md`](maintainer-credentials.md).
