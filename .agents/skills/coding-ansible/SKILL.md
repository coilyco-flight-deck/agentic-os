...
Umbrella for any Ansible work. Ansible is the **host-convergence leg** of the trifecta (see [`coding-shape-iac`](../coding-shape-iac/SKILL.md)): it converges OS and service state that is not API-shaped. Terraform hits APIs, Kubernetes orchestrates containers, Ansible does the rest.
...
- [`coding-shape-iac`](../coding-shape-iac/SKILL.md) - the IaC umbrella and the trifecta framing.
- [`coding-kubernetes`](../coding-kubernetes/SKILL.md) - the other half of the boundary (containerized workloads stay here).
- [`coding-terraform`](../coding-terraform/SKILL.md) - the API-hitting leg.
