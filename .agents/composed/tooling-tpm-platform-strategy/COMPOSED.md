...
1. TPM names the platform customer and the recurring job that customer needs
   to complete.
...
TPM weighs the expected reduction in cognitive load, lead time, reliability
...
TPM defines the next bounded investment, responsible role, adoption evidence,
service expectation, migration sequence, and cost the portfolio accepts. TPM
