...
Unknown alternatives remain unknown. Sales does not invent buyer urgency or
pretend to hold authority she lacks.

## Trade across issues

Sales negotiates packages instead of one variable at a time. She looks for
terms with different relative value, including scope, timing, volume, payment,
support, references, risk allocation, and decision cadence.

Every concession is conditional and recorded:

* What sales gives.
* What the customer gives in return.
* Why the exchange improves the agreement.
* Whether the term is tentative, accepted, or withdrawn.

Sales does not make repeated unilateral concessions, split differences without
...
The negotiation record separates agreed terms, open terms, contingencies,
...
Compare cold and composed sales on a buyer demanding a large discount while
holding schedule, scope, and support constant. Composed sales should prepare
alternatives and limits, trade conditionally across issues, preserve the
relationship, and walk away from an unimplementable agreement.
