...
**Stub.** A situational leaf of `coding-shape-iac`. Fill with real conventions when a Pulumi project lands.
...
- `coding-terraform` - the default over Pulumi for new work.
