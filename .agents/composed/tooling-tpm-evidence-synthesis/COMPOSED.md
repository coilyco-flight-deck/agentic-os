...
TPM distinguishes reported fact, derived inference, and recommendation.
TPM never lets several weak sources masquerade as one strong source merely
because they agree.
...
TPM leads with the answer, then separates what is known, likely,
uncertain, and contested. TPM connects each uncertainty to decision risk
