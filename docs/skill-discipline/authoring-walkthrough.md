...
Body length: see [`check_documentation_layout.py`](../../agentic_os/check_documentation_layout.py) for the loader-bound tier caps. If you outgrow either, split into sibling `<skill>/<topic>.md` files linked from the SKILL.md, not inlined.
