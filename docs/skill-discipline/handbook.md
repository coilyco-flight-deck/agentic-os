...
* every Markdown file stays under the size cap enforced by [`check_documentation_layout.py`](../../agentic_os/check_documentation_layout.py). AGENTS.md and SKILL.md are not exempt.
