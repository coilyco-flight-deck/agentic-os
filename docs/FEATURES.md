...
- [Agents and sessions](features-agents-sessions.md) - agent self-name, session pulse, and a project-local status-line disk-footprint tracker ([`.agentic-os/statusline.sh`](../.agentic-os/statusline.sh)) that flags working-tree growth since a baseline.
