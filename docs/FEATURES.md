...
- [Goose issue triage](goose-triage.md) - `ward exec goose-triage` runs real issue triage with the local Goose + `qwen3-coder:30b` harness as the judgment engine: P0 regex net, Goose confirm, two-pass urgency scoring, percentile cut into P0-P4, report-only. The production application of the issue-prioritization method on a local model.
