...
`AOS_NATIVE_SESSIONS_DIR` allow overrides. See [startup narration](native-startup-narration.md),
the [shell owner](features-shell-secrets.md), and [Claude config](native-claude-config.md).
