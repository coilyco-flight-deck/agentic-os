...
<!-- freshness: as-of=2026-06-24 decay-class=derived half-life=fast source="ward ops forgejo describe" -->

# ward ops forgejo - committed reference

**as-of:** 2026-06-24 - **source:** `ward ops forgejo describe` (v0.117.0) - **regenerate:** `ward exec gen-ward-ops-reference`
