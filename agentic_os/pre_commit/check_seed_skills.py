...
``coding-core-git``) so that context is present for ingestion.
...
fails if the repo lacks a reference to an expected delivered skill path or its
canonical composed source, e.g. ``.agents/skills/coding-python/SKILL.md`` or
