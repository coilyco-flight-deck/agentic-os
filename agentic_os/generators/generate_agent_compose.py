...
mount-eligibility manifest (forgejo #222) at
...
# Mount-eligibility manifest (#222): the composer's scope/harness selection as
...
# Always-on default mount set (epic #220): mounted regardless of task or harness.
