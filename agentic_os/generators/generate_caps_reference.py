...
GENERATED_HEADER = (
    ...
    "<!-- Regenerate: ward exec gen-caps-reference (check-caps-reference-drift "
    "guards staleness). -->\n"
)
...
def _caps() -> list[tuple[str, str, str, str]]:
    ...
    return [
        ...
        (
            ...
            "markdown lines",
            str(dl.MAX_MARKDOWN_LINES),
            "non-blank lines for most `.md` files",
        ),
        (
            "documentation-layout",
            "markdown chars",
            str(dl.MAX_MARKDOWN_CHARS),
            "characters for most `.md` files",
        ),
        (
            "documentation-layout",
...
def render_doc() -> str:
    ...
    lines.append(
        ...
        "`ward exec gen-caps-reference`, never this file."
    )
    lines.append("")
    lines.append(
...
def check_drift(doc_path: Path = DOC_PATH) -> int:
    ...
    sys.stderr.write(
        ...
        "hand-edited. Run `ward exec gen-caps-reference` to regenerate.\n"
    )
